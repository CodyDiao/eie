...
{
  /* Block the processor for over 1ms to force a 1ms violation debug message.
  Note a "for" loop is about 4 instruction cycles long and each instrcution cycle
  is 21ns. 1ms / 21ns ~= 50,000. So a 50k loop will be about 3ms */
